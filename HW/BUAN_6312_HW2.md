...
Instrumental variables 2SLS regression
      ...
      Source |       SS           df       MS      Number of obs   =        55
-------------+----------------------------------   F(1, 53)        =      2.49
       Model |  41.0357451         1  41.0357451   Prob > F        =    0.1205
    Residual |  449.281356        53  8.47700671   R-squared       =    0.0837
-------------+----------------------------------   Adj R-squared   =    0.0664
       Total |  490.317101        54  9.07994631   Root MSE        =    2.9115

------------------------------------------------------------------------------
         inf | Coefficient  Std. err.      t    P>|t|     [95% conf. interval]
-------------+----------------------------------------------------------------
        unem |   .5533613   .3506861     1.58   0.121     -.150026    1.256749
       _cons |   .6712233   2.025838     0.33   0.742    -3.392094    4.734541
------------------------------------------------------------------------------
Instrumented: unem
 Instruments: unem_1
